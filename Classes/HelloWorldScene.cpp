...
bool HelloWorld::init()
{
	...
	//auto startItem = Label::createWithTTF("START GAME", "fonts/arial.ttf", 36);
	//startItem->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height - startItem->getContentSize().height));

	//auto menu1 = Menu::create(startItem);
	//menu1->setPosition(Vec2::ONE);
	...
	MenuItemFont::setFontName("world");
	...
	MenuItemFont* item3 = MenuItemFont::create("Set", CC_CALLBACK_1(HelloWorld::menuItem3Callback, this));
...
{
	MenuItem* item = (MenuItem*)pSender;
	log("Touch Set Menu Item %p", item);
}
