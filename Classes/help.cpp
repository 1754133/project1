...
bool help::init()
{
	...
	auto label1 = Label::createWithTTF("stop", "fonts/arial.ttf", 32);
	...
	auto label2 = Label::createWithTTF("continue", "fonts/arial.ttf", 32);
	label2->setPosition(Vec2(320, 550));
	this->addChild(label2, 1);

	auto sprite3 = Sprite::create("change.jpg");
	sprite3->setPosition(Vec2(200, 500));
	this->addChild(sprite3, 0);
	auto label3 = Label::createWithTTF("change the type", "fonts/arial.ttf", 32);
	label3->setPosition(Vec2(360, 500));
	this->addChild(label3, 1);

	auto sprite4 = Sprite::create("left.jpg");
	sprite4->setPosition(Vec2(200, 450));
	this->addChild(sprite4, 0);
	auto label4 = Label::createWithTTF("left", "fonts/arial.ttf", 32);
	...
	auto label5 = Label::createWithTTF("right", "fonts/arial.ttf", 32);
	...
	auto label6 = Label::createWithTTF("down", "fonts/arial.ttf", 32);
