...
bool help::init()
{
	...
	auto sprite7 = Sprite::create("space.jpg");
	sprite7->setPosition(Vec2(200, 300));
	this->addChild(sprite7, 0);
	auto label7 = Label::createWithTTF("to the bottom", "fonts/airstrikeacad.ttf", 32);
	label7->setPosition(Vec2(460, 300));
